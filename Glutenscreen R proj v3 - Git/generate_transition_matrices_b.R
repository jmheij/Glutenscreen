...
########################################################################################################################  
## inneficient but working code, this sections enables the calling of children/adult parameters (i.e. late diagnosis and genpop rates) depending on cycle whenever possible 
  
#from state to GIC
  #ages 2-10 years old
    transition_matrices[, 1:(10-starting_age +1), "diagnosed no complications", "diagnosed GIC"] <- 
      transition_matrices[, 1:(10-starting_age+1), "diagnosed osteoporosis", "diagnosed GIC"] <-
      transition_matrices[, 1:(10-starting_age+1), "diagnosed NHL", "diagnosed GIC"] <- 
      GIC_probability_GFD_all$GIC_probability_GFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "Undiagnosed GIC"] <-
      transition_matrices[, 1:(10-starting_age+1), "Undiagnosed osteoporosis", "Undiagnosed GIC"] <-
      transition_matrices[, 1:(10-starting_age+1), "Undiagnosed NHL", "Undiagnosed GIC"] <-
      (1 - input_parameters$probability_late_diagnosis_children) * GIC_probability_noGFD_all$GIC_probability_noGFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed GIC"] <-
      transition_matrices[, 1:(10-starting_age+1), "Undiagnosed osteoporosis", "diagnosed GIC"] <-
      transition_matrices[, 1:(10-starting_age+1), "Undiagnosed NHL", "diagnosed GIC"] <-
      input_parameters$probability_late_diagnosis_children * GIC_probability_noGFD_all$GIC_probability_noGFD_0
    transition_matrices[, 1:(10-starting_age+1),"Undiagnosed GIC", "diagnosed GIC"] <- input_parameters$probability_late_diagnosis_children 
    #ages 11-18 years old
    transition_matrices[, (10-starting_age+2):(18-starting_age +1), "diagnosed no complications", "diagnosed GIC"] <- 
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "diagnosed osteoporosis", "diagnosed GIC"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "diagnosed NHL", "diagnosed GIC"] <- 
      GIC_probability_GFD_all$GIC_probability_GFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "Undiagnosed GIC"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed osteoporosis", "Undiagnosed GIC"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed NHL", "Undiagnosed GIC"] <-
      (1 - input_parameters$probability_late_diagnosis_children) * GIC_probability_noGFD_all$GIC_probability_noGFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "diagnosed GIC"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed osteoporosis", "diagnosed GIC"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed NHL", "diagnosed GIC"] <-
      input_parameters$probability_late_diagnosis_children * GIC_probability_noGFD_all$GIC_probability_noGFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1),"Undiagnosed GIC", "diagnosed GIC"] <- input_parameters$probability_late_diagnosis_children 
    #ages 19-21, necessary for next chunck of code (cycles 21-onwards)
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "diagnosed no complications", "diagnosed GIC"] <- 
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "diagnosed osteoporosis", "diagnosed GIC"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "diagnosed NHL", "diagnosed GIC"] <- 
      GIC_probability_GFD_all$GIC_probability_GFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "Undiagnosed GIC"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed osteoporosis", "Undiagnosed GIC"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed NHL", "Undiagnosed GIC"] <-
      (1 - input_parameters$probability_late_diagnosis_adults) * GIC_probability_noGFD_all$GIC_probability_noGFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "diagnosed GIC"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed osteoporosis", "diagnosed GIC"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed NHL", "diagnosed GIC"] <-
      input_parameters$probability_late_diagnosis_adults * GIC_probability_noGFD_all$GIC_probability_noGFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1),"Undiagnosed GIC", "diagnosed GIC"] <- input_parameters$probability_late_diagnosis_adults   
  #ages 22-onwards
    ...
    #repeated, from state to NHL
    #ages 2-10
    transition_matrices[, 1:(10-starting_age+1), "diagnosed no complications", "diagnosed NHL"] <- 
      transition_matrices[, 1:(10-starting_age+1), "diagnosed osteoporosis", "diagnosed NHL"] <-
      NHL_probability_GFD_all$NHL_probability_GFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "Undiagnosed NHL"] <-
      transition_matrices[, 1:(10-starting_age+1), "Undiagnosed osteoporosis", "Undiagnosed NHL"] <-
      (1 - input_parameters$probability_late_diagnosis_children) * NHL_probability_noGFD_all$NHL_probability_noGFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed NHL"] <-
      transition_matrices[, 1:(10-starting_age+1), "Undiagnosed osteoporosis", "diagnosed NHL"] <-
      input_parameters$probability_late_diagnosis_children * NHL_probability_noGFD_all$NHL_probability_noGFD_0
    transition_matrices[, 1:(10-starting_age+1),"Undiagnosed NHL", "diagnosed NHL"] <- input_parameters$probability_late_diagnosis_children - 
      (transition_matrices[, 1:(10-starting_age+1), "Undiagnosed NHL","diagnosed GIC"])
    #ages 11-18
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "diagnosed no complications", "diagnosed NHL"] <- 
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "diagnosed osteoporosis", "diagnosed NHL"] <-
      NHL_probability_GFD_all$NHL_probability_GFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "Undiagnosed NHL"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed osteoporosis", "Undiagnosed NHL"] <-
      (1 - input_parameters$probability_late_diagnosis_children) * NHL_probability_noGFD_all$NHL_probability_noGFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "diagnosed NHL"] <-
      transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed osteoporosis", "diagnosed NHL"] <-
      input_parameters$probability_late_diagnosis_children * NHL_probability_noGFD_all$NHL_probability_noGFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1),"Undiagnosed NHL", "diagnosed NHL"] <- input_parameters$probability_late_diagnosis_children - 
      (transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed NHL","diagnosed GIC"])
    #ages 19-21, necessary for next chunck of code (cycles 21-onwards)
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "diagnosed no complications", "diagnosed NHL"] <- 
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "diagnosed osteoporosis", "diagnosed NHL"] <-
      NHL_probability_GFD_all$NHL_probability_GFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "Undiagnosed NHL"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed osteoporosis", "Undiagnosed NHL"] <-
      (1 - input_parameters$probability_late_diagnosis_adults) * NHL_probability_noGFD_all$NHL_probability_noGFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "diagnosed NHL"] <-
      transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed osteoporosis", "diagnosed NHL"] <-
      input_parameters$probability_late_diagnosis_adults * NHL_probability_noGFD_all$NHL_probability_noGFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1),"Undiagnosed NHL", "diagnosed NHL"] <- input_parameters$probability_late_diagnosis_adults - 
      (transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed NHL","diagnosed GIC"])   
    #ages 22-onwards
    n_agecategories <- (n_cycles/10) - 1
    for(i_age_category in c(2:n_agecategories)) {
  ...
  # from no complications to OSTEOPOROSIS and no complications
    #ages 2-10
    transition_matrices[, 1:(10-starting_age+1), "diagnosed no complications", "diagnosed osteoporosis"] <- osteoporosis_probability_GFD_all$osteoporosis_probability_GFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "Undiagnosed osteoporosis"] <- (1 - input_parameters$probability_late_diagnosis_children) * osteoporosis_probability_noGFD_all$osteoporosis_probability_noGFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed osteoporosis"] <-  input_parameters$probability_late_diagnosis_children * osteoporosis_probability_noGFD_all$osteoporosis_probability_noGFD_0
    transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed no complications"] <- input_parameters$probability_late_diagnosis_children - (
                                                                                                                   (transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed osteoporosis"]) +
                                                                                                                   (transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed NHL"]) +
                                                                                                                   (transition_matrices[, 1:(10-starting_age+1), "Undiagnosed no complications", "diagnosed GIC"])
                                                                                                                   ) 
    transition_matrices[,1:(10-starting_age+1) ,"Undiagnosed osteoporosis", "diagnosed osteoporosis"] <- input_parameters$probability_late_diagnosis_children - (
                                                                                                                   (transition_matrices[, 1:(10-starting_age+1),"Undiagnosed osteoporosis", "diagnosed NHL"]) +
                                                                                                                   (transition_matrices[, 1:(10-starting_age+1),"Undiagnosed osteoporosis", "diagnosed GIC"])
                                                                                                                   )
    #ages 11-18
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "diagnosed no complications", "diagnosed osteoporosis"] <- osteoporosis_probability_GFD_all$osteoporosis_probability_GFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "Undiagnosed osteoporosis"] <- (1 - input_parameters$probability_late_diagnosis_children) * osteoporosis_probability_noGFD_all$osteoporosis_probability_noGFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "diagnosed osteoporosis"] <-  input_parameters$probability_late_diagnosis_children * osteoporosis_probability_noGFD_all$osteoporosis_probability_noGFD_10
    transition_matrices[, (10-starting_age+2):(18-starting_age+1),"Undiagnosed no complications", "diagnosed no complications"] <- input_parameters$probability_late_diagnosis_children - (
                                                                                                                                        (transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "diagnosed osteoporosis"] ) +
                                                                                                                                        (transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "diagnosed NHL"] ) +
                                                                                                                                        (transition_matrices[, (10-starting_age+2):(18-starting_age+1), "Undiagnosed no complications", "diagnosed GIC"] ) 
                                                                                                                                        ) 
    transition_matrices[,(10-starting_age+2):(18-starting_age+1) ,"Undiagnosed osteoporosis", "diagnosed osteoporosis"] <- input_parameters$probability_late_diagnosis_children - (
                                                                                                                                       (transition_matrices[, (10-starting_age+2):(18-starting_age+1),"Undiagnosed osteoporosis", "diagnosed NHL"]) +
                                                                                                                                       (transition_matrices[, (10-starting_age+2):(18-starting_age+1),"Undiagnosed osteoporosis", "diagnosed GIC"])
                                                                                                                                       )
    #ages 19-21, necessary for next chunck of code (cycles 21-onwards)
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "diagnosed no complications", "diagnosed osteoporosis"] <- osteoporosis_probability_GFD_all$osteoporosis_probability_GFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "Undiagnosed osteoporosis"] <- (1 - input_parameters$probability_late_diagnosis_adults) * osteoporosis_probability_noGFD_all$osteoporosis_probability_noGFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "diagnosed osteoporosis"] <-  input_parameters$probability_late_diagnosis_adults * osteoporosis_probability_noGFD_all$osteoporosis_probability_noGFD_20
    transition_matrices[, (18-starting_age+2):(21-starting_age+1),"Undiagnosed no complications", "diagnosed no complications"] <- input_parameters$probability_late_diagnosis_adults - (
                                                                                                                                       (transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "diagnosed osteoporosis"] ) +
                                                                                                                                       (transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "diagnosed NHL"] ) +
                                                                                                                                       (transition_matrices[, (18-starting_age+2):(21-starting_age+1), "Undiagnosed no complications", "diagnosed GIC"] ) 
                                                                                                                                        ) 
    transition_matrices[,(18-starting_age+2):(21-starting_age+1) ,"Undiagnosed osteoporosis", "diagnosed osteoporosis"] <- input_parameters$probability_late_diagnosis_adults - (
                                                                                                                                       (transition_matrices[, (18-starting_age+2):(21-starting_age+1),"Undiagnosed osteoporosis", "diagnosed NHL"]) +
                                                                                                                                       (transition_matrices[, (18-starting_age+2):(21-starting_age+1),"Undiagnosed osteoporosis", "diagnosed GIC"])
                                                                                                                                       )
   ...
   for(i_age_category in c(2:n_agecategories)) {
     ...
     transition_matrices[, (c(1:10) + i_age_category * 10),"Undiagnosed no complications", "diagnosed no complications"] <- input_parameters$probability_late_diagnosis_adults - (
                                                                                                                                      (transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed no complications", "diagnosed osteoporosis"] ) +
                                                                                                                                      (transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed no complications", "diagnosed NHL"] ) +
                                                                                                                                      (transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed no complications", "diagnosed GIC"] ) 
                                                                                                                                      ) 
     transition_matrices[,(c(1:10) + i_age_category * 10) ,"Undiagnosed osteoporosis", "diagnosed osteoporosis"] <- input_parameters$probability_late_diagnosis_adults - (
                                                                                                                                      (transition_matrices[, (c(1:10) + i_age_category * 10),"Undiagnosed osteoporosis", "diagnosed NHL"]) +
                                                                                                                                      (transition_matrices[, (c(1:10) + i_age_category * 10),"Undiagnosed osteoporosis", "diagnosed GIC"])
                                                                                                                                      )
   }
